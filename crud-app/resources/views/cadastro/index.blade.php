                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <form action="{{ route('cadastros.destroy',$cadastro->id) }}" method="POST">
                                                    <a class="btn btn-sm btn-primary " href="{{ route('cadastros.show',$cadastro->id) }}"><i class="fa fa-fw fa-eye"></i> Show</a>
                                                    <a class="btn btn-sm btn-success" href="{{ route('cadastros.edit',$cadastro->id) }}"><i class="fa fa-fw fa-edit"></i> Edit</a>
                                                    @csrf
                                                    @method('DELETE')
